...
export default function PlatformEnrollPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl rounded-3xl border border-slate-800 bg-slate-900/70 p-6 md:p-8">
      ...
      <p className="mt-3 text-slate-300">首期仅需 GitHub 登录，不再要求钱包登录。完成绑定后即可提交任务仓库并触发 webhook 审核。</p>
      ...
      <section className="mt-6 rounded-2xl border border-cyan-400/30 bg-cyan-500/10 p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-3">
          ...
          <button
            className="rounded-xl border border-cyan-300/60 px-4 py-2 text-sm text-cyan-100 transition hover:bg-cyan-400/10"
        ...
        <p className="mt-2 text-xs text-slate-300">后端未接入前可点击“本地模拟已登录”继续联调界面。</p>
      </section>
